...
$(document).ready(function(){
 ...
 // ajax for the news
  ...
  $.ajax({
    ...
    console.log("ajax failed due to no internet connection");
    if("indexedDB" in window) { 
      console.log("Indexeddb suppported for your browser and retreving info from the indexeddb");
        // to display all data
      var db;
    ...
    // pushing data to the indexdb
      if("indexedDB" in window) { 
        console.log("Indexeddb suppported in your browser. Saving a copy of the data in the IndexedDB");
